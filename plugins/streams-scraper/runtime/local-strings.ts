...
const STRINGS = {
  en: {
    ...
    addonReasonTimeout: 'no answer within the time limit',
    addonReasonHttp: 'answered {status}',
    addonReasonNetwork: 'could not be reached (network or CORS)',
    addonReasonInvalid: 'answered with something that is not a stream list',
  ...
  sv: {
    ...
    communitySource: 'Community-addon',
    addonReasonTimeout: 'svarade inte inom tidsgränsen',
    addonReasonHttp: 'svarade {status}',
    addonReasonNetwork: 'gick inte att nå (nät eller CORS)',
    addonReasonInvalid: 'svarade med något som inte är en strömlista',
